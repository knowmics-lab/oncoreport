...
cosmic_references <- read.csv(paste0(path_project, "/txt/reference/", pt_fastq, "_cosmic.txt"), sep = "\t", 
                              colClasses = "character", stringsAsFactors = FALSE)
cosmic_references <- cosmic_references[, c("PMID", "Reference")]

cosmic_data_orig <- read.csv(paste0(path_project, "/txt/", pt_fastq, "_cosmic.txt"), sep = "\t", 
                             colClasses = "character", stringsAsFactors = FALSE)
